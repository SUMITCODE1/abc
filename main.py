...
lblSalary.grid(row=2, column=0, padx=10, pady=10, sticky="w")
...
def add_employee():
    if txtName.get() == "" or txtAge.get() == "" or txtSalary.get() == ""  or txtAddress.get(
            1.0, END) == "":
        messagebox.showerror("Erorr in Input", "Please Fill All the Details")
        return
    db.insert(txtName.get(),txtAge.get(), txtSalary.get() , txtAddress.get(
            1.0, END))
...
def update_employee():
    if txtName.get() == "" or txtAge.get() == "" or txtSalary.get() == "" or txtAddress.get(
        ...
        messagebox.showerror("Erorr in Input", "Please Fill All the Details")
        return
    db.update(row[0],txtName.get(), txtAge.get(), txtSalary.get(),
              txtAddress.get(
                  1.0, END))
